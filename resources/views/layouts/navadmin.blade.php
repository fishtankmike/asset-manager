    ...
    <div class="navbar-container container-fluid">
        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
                ...
                <li class="dropdown">
                    <a class="navbar-avatar dropdown-toggle" data-toggle="dropdown" href="#" aria-expanded="false" data-animation="scale-up" role="button"> <span class="avatar">
...
<div class="site-menubar">
                ...
                <ul class="site-menu">
                    <li class="site-menu-category">Assets</li>
                     ...
                     <li class="site-menu-item">
                        <a href="{{ url('/admin/asset/create') }}"> <i class="site-menu-icon wb-add-file" aria-hidden="true"></i> <span class="site-menu-title">Add New</span> </a>

                    </li>

                      <li class="site-menu-item">
                        <a href="{{ url('/admin/assets') }}"> <i class="site-menu-icon wb-file" aria-hidden="true"></i> <span class="site-menu-title">View All</span> </a>

                    </li>


                <!--      <li class="site-menu-item">
                        <a href="javascript:void(0)"> <i class="site-menu-icon wb-add-file" aria-hidden="true"></i> <span class="site-menu-title">Add New</span> </a> -->
                    ...
                    <li class="site-menu-item has-sub">
                        ...
                        <ul class="site-menu-sub">
                            {!! recursive_list(App\Category::with('children')->whereNull('parent_id')->orderBy('id')->get(), true) !!}
                        </ul>
                    </li>
                    <li class="site-menu-item">
                        <a href="{{ Request::fullUrlWithQuery(['download' => 'zip']) }}"> <i class="site-menu-icon wb-download" aria-hidden="true"></i> <span class="site-menu-title">Download</span> </a>
                    </li>
                    ...
                    <li class="site-menu-category">User Accounts</li>


                      <li class="site-menu-item">
                        <a href="{{ url('/admin/user/create') }}"> <i class="site-menu-icon wb-user-add" aria-hidden="true"></i> <span class="site-menu-title">Add User</span> </a>

                    </li>


                      <li class="site-menu-item">
                        <a href="{{ url('/admin/users') }}"> <i class="site-menu-icon wb-user" aria-hidden="true"></i> <span class="site-menu-title">All Users</span> </a>
    ...
    <div class="site-menubar-footer">
        <a href="{{ url('/admin/users') }}" class="fold-show" data-placement="top" data-toggle="tooltip" data-original-title="Settings"> <span class="icon wb-settings" aria-hidden="true"></span> </a>
